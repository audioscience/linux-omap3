...
struct cppi41_dma_block cppi41_dma_block[CPPI41_NUM_DMA_BLOCK] = {
	[0] = {
		...
		.ch_ctrl_stat_base =
			IO_ADDRESS(OMAP3517_HSUSB_OTG_BASE) + 0x1800,
		.sched_ctrl_base =
			IO_ADDRESS(OMAP3517_HSUSB_OTG_BASE) + 0x2000,
		.sched_table_base =
			IO_ADDRESS(OMAP3517_HSUSB_OTG_BASE) + 0x2800,
		.num_tx_ch	= 15,
		.num_rx_ch	= 15,
...
struct cppi41_queue_mgr cppi41_queue_mgr[CPPI41_NUM_QUEUE_MGR] = {
	[0] = {
		...
		.desc_mem_rgn_base =
			IO_ADDRESS(OMAP3517_HSUSB_OTG_BASE) + 0x5000,
		.q_mgmt_rgn_base =
			IO_ADDRESS(OMAP3517_HSUSB_OTG_BASE) + 0x6000,
		.q_stat_rgn_base =
