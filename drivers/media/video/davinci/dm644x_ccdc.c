...
{
	/*
	 * TODO:  This is not applicable for OMAP3517, so need to decide on
	 * this
	 */
#ifdef CONFIG_DISPLAY_DAVINCI_DM646X_EVM
...
static void ccdc_clr_intr(void *__iomem ccdc_intr_clr_addr, int vdint)
{
