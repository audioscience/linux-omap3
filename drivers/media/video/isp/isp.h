...
/* ISP Private IOCTLs */
#define VIDIOC_PRIVATE_ISP_CCDC_CFG		(BASE_VIDIOC_PRIVATE + 0)
#define VIDIOC_PRIVATE_ISP_PRV_CFG		(BASE_VIDIOC_PRIVATE + 1)
#define VIDIOC_PRIVATE_ISP_AEWB_CFG		(BASE_VIDIOC_PRIVATE + 2)
#define VIDIOC_PRIVATE_ISP_AEWB_REQ		(BASE_VIDIOC_PRIVATE + 3)
#define VIDIOC_PRIVATE_ISP_HIST_CFG		(BASE_VIDIOC_PRIVATE + 4)
#define VIDIOC_PRIVATE_ISP_HIST_REQ		(BASE_VIDIOC_PRIVATE + 5)
#define VIDIOC_PRIVATE_ISP_AF_CFG		(BASE_VIDIOC_PRIVATE + 6)
#define VIDIOC_PRIVATE_ISP_AF_REQ		(BASE_VIDIOC_PRIVATE + 7)
