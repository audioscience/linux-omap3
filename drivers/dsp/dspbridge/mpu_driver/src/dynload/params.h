...
#define FILL_MIN_WIDTH  4	/* minimum fill value width, in bytes. */
#define FILL_MAX_WIDTH  4	/* maximum fill value width, in bytes. */
...
#define FILL_MIN_WIDTH  2	/* minimum fill value width, in bytes. */
#define FILL_MAX_WIDTH  2	/* maximum fill value width, in bytes. */
#define FILL_FLAGS      0	/* extra flags for FILL sections   */
...
#define FILL_MIN_WIDTH  3	/* minimum fill value width, in bytes. */
#define FILL_MAX_WIDTH  3	/* maximum fill value width, in bytes. */
#define FILL_FLAGS      0	/* extra flags for FILL sections   */
