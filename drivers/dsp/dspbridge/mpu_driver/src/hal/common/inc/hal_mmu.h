...
extern HAL_STATUS HAL_MMU_NumLockedGet(const UWORD32 baseAddress,
					UWORD32 *numLockedEntries);

extern HAL_STATUS HAL_MMU_NumLockedSet(const UWORD32 baseAddress,
					UWORD32 numLockedEntries);

extern HAL_STATUS HAL_MMU_VictimNumGet(const UWORD32 baseAddress,
...
extern HAL_STATUS HAL_MMU_TWLIsEnabled(const UWORD32 baseAddress,
					UWORD32 *twlIsEnabled);

extern HAL_STATUS HAL_MMU_TWLIsRunning(const UWORD32    baseAddress,
...
extern HAL_STATUS HAL_MMU_IdleModeSet(const UWORD32 baseAddress,
					      HAL_IdleMode_t mode);

extern HAL_STATUS HAL_MMU_AutoIdleEnable(const UWORD32 baseAddress);

extern HAL_STATUS HAL_MMU_AutoIdleDisable(const UWORD32 baseAddress);

extern HAL_STATUS HAL_MMU_SysConfigGet(const UWORD32 baseAddress,
					       UWORD32 *value);
