 ...
 *! Revision History
 *! ================
 *! 19-Apr-2004 sb:  configureDspMmu calls HAL_MMU_TLBAdd directly now.
...
void configureDspMmu(struct WMD_DEV_CONTEXT *pDevContext, DWORD dataBasePhys,
		    ...
		    HAL_Endianism_t endianism, HAL_ElementSize_t elemSize,
		    HAL_MMUMixedSize_t mixedSize)
{
	struct CFG_HOSTRES resources;
	struct HAL_MMUMapAttrs_t mapAttrs = { endianism, elemSize, mixedSize };
	...
	status = HAL_MMU_TLBAdd(pDevContext->dwDSPMmuBase, dataBasePhys,
