...
static const struct BPWR_Clk_t BPWR_Clks[] = {
	{(DWORD) BPWR_GPTimer5, OSALCLK_gpt5_fck, OSALCLK_gpt5_ick},
	{(DWORD) BPWR_GPTimer6, OSALCLK_gpt6_fck, OSALCLK_gpt6_ick},
	{(DWORD) BPWR_GPTimer7, OSALCLK_gpt7_fck, OSALCLK_gpt7_ick},
	{(DWORD) BPWR_GPTimer8, OSALCLK_gpt8_fck, OSALCLK_gpt8_ick},
	{(DWORD) BPWR_WDTimer3, OSALCLK_wdt3_fck, OSALCLK_wdt3_ick},
	{(DWORD) BPWR_MCBSP1, OSALCLK_mcbsp1_fck, OSALCLK_mcbsp1_ick},
	{(DWORD) BPWR_MCBSP2, OSALCLK_mcbsp2_fck, OSALCLK_mcbsp2_ick},
	{(DWORD) BPWR_MCBSP3, OSALCLK_mcbsp3_fck, OSALCLK_mcbsp3_ick},
	{(DWORD) BPWR_MCBSP4, OSALCLK_mcbsp4_fck, OSALCLK_mcbsp4_ick},
	{(DWORD) BPWR_MCBSP5, OSALCLK_mcbsp5_fck, OSALCLK_mcbsp5_ick},
