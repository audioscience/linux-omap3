...
/* Display debugging state/varibles */
#define DBG_LEVEL1  (BYTE)(0x02 & DEBUGZONE(1))
#define DBG_LEVEL2  (BYTE)(0x04 & DEBUGZONE(2))
#define DBG_LEVEL3  (BYTE)(0x08 & DEBUGZONE(3))
#define DBG_LEVEL4  (BYTE)(0x10 & DEBUGZONE(4))
