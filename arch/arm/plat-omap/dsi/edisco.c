...
void get_edisco_platform_config(T_EDISCO_DIS *edisco_dis)
{
	...
	edisco_dis->max_data_rate = 0; /*TODO: need to be filled with the data from edisco datasheet */
	...
	edisco_dis->max_resp_size = 0;/*TODO: need to be filled with the data from edisco datasheet */
	edisco_dis->display_mode = DSI_VIDEO_MODE;
	edisco_dis->input_clk_fre = REFCLK_32KHZ;
}

/*-----------------------------------------------------------------------------
| Function    : void get_edisco_vm_timing(T_VM_TIMING *video_mode_timing, U16 image_size)
+------------------------------------------------------------------------------
