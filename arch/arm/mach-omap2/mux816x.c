/*
 * TI816X Mux data. Probably needs merge with mux34xx.c
 *
...
int __init ti816x_mux_init(struct omap_board_mux *board_subset)
{
	return omap_mux_init(TI816X_CONTROL_PADCONF_MUX_PBASE,
			     TI816X_CONTROL_PADCONF_MUX_SIZE,
				ti816x_muxmodes, NULL, board_subset,
				NULL);
}
#else
int __init ti816x_mux_init(struct omap_board_mux *board_subset)
