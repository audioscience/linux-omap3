...
#define TI816X_CTRL_REGADDR(reg)					\
		TI81XX_L4_SLOW_IO_ADDRESS(TI81XX_CTRL_BASE + (reg))
#else
#define OMAP242X_CTRL_REGADDR(reg)					\
		OMAP2_L4_IO_ADDRESS(OMAP242X_CTRL_BASE + (reg))
#define OMAP243X_CTRL_REGADDR(reg)					\
...
/* TI816X PLL Control register offsets */
#define TI816X_MAINPLL_CTRL		TI816X_CTRL_REGADDR(0x0400)
#define TI816X_MAINPLL_PWD		TI816X_CTRL_REGADDR(0x0404)
#define TI816X_MAINPLL_FREQ1		TI816X_CTRL_REGADDR(0x0408)
#define TI816X_MAINPLL_DIV1		TI816X_CTRL_REGADDR(0x040C)
#define TI816X_MAINPLL_FREQ2		TI816X_CTRL_REGADDR(0x0410)
#define TI816X_MAINPLL_DIV2		TI816X_CTRL_REGADDR(0x0414)
#define TI816X_MAINPLL_FREQ3		TI816X_CTRL_REGADDR(0x0418)
#define TI816X_MAINPLL_DIV3		TI816X_CTRL_REGADDR(0x041C)
#define TI816X_MAINPLL_FREQ4		TI816X_CTRL_REGADDR(0x0420)
#define TI816X_MAINPLL_DIV4		TI816X_CTRL_REGADDR(0x0424)
#define TI816X_MAINPLL_FREQ5		TI816X_CTRL_REGADDR(0x0428)
#define TI816X_MAINPLL_DIV5		TI816X_CTRL_REGADDR(0x042C)
#define TI816X_MAINPLL_DIV6		TI816X_CTRL_REGADDR(0x0434)
#define TI816X_MAINPLL_DIV7		TI816X_CTRL_REGADDR(0x043C)

#define TI816X_DDRPLL_CTRL		TI816X_CTRL_REGADDR(0x0440)
#define TI816X_DDRPLL_PWD		TI816X_CTRL_REGADDR(0x0444)
#define TI816X_DDRPLL_DIV1		TI816X_CTRL_REGADDR(0x044C)
#define TI816X_DDRPLL_FREQ2		TI816X_CTRL_REGADDR(0x0450)
#define TI816X_DDRPLL_DIV2		TI816X_CTRL_REGADDR(0x0454)
#define TI816X_DDRPLL_FREQ3		TI816X_CTRL_REGADDR(0x0458)
#define TI816X_DDRPLL_DIV3		TI816X_CTRL_REGADDR(0x045C)
#define TI816X_DDRPLL_FREQ4		TI816X_CTRL_REGADDR(0x0460)
#define TI816X_DDRPLL_DIV4		TI816X_CTRL_REGADDR(0x0464)
#define TI816X_DDRPLL_FREQ5		TI816X_CTRL_REGADDR(0x0468)
#define TI816X_DDRPLL_DIV5		TI816X_CTRL_REGADDR(0x046C)

#define TI816X_DDR_RCD			TI816X_CTRL_REGADDR(0x070C)

#define TI816X_VIDEOPLL_CTRL		TI816X_CTRL_REGADDR(0x0470)
#define TI816X_VIDEOPLL_PWD		TI816X_CTRL_REGADDR(0x0474)
#define TI816X_VIDEOPLL_FREQ1		TI816X_CTRL_REGADDR(0x0478)
#define TI816X_VIDEOPLL_DIV1		TI816X_CTRL_REGADDR(0x047C)
#define TI816X_VIDEOPLL_FREQ2		TI816X_CTRL_REGADDR(0x0480)
#define TI816X_VIDEOPLL_DIV2		TI816X_CTRL_REGADDR(0x0484)
#define TI816X_VIDEOPLL_FREQ3		TI816X_CTRL_REGADDR(0x0488)
#define TI816X_VIDEOPLL_DIV3		TI816X_CTRL_REGADDR(0x048C)

#define TI816X_AUDIOPLL_CTRL		TI816X_CTRL_REGADDR(0x04A0)
#define TI816X_AUDIOPLL_PWD		TI816X_CTRL_REGADDR(0x04A4)
#define TI816X_AUDIOPLL_FREQ2		TI816X_CTRL_REGADDR(0x04B0)
#define TI816X_AUDIOPLL_DIV2		TI816X_CTRL_REGADDR(0x04B4)
#define TI816X_AUDIOPLL_FREQ3		TI816X_CTRL_REGADDR(0x04B8)
#define TI816X_AUDIOPLL_DIV3		TI816X_CTRL_REGADDR(0x04BC)
#define TI816X_AUDIOPLL_FREQ4		TI816X_CTRL_REGADDR(0x04C0)
#define TI816X_AUDIOPLL_DIV4		TI816X_CTRL_REGADDR(0x04C4)
#define TI816X_AUDIOPLL_FREQ5		TI816X_CTRL_REGADDR(0x04C8)
#define TI816X_AUDIOPLL_DIV5		TI816X_CTRL_REGADDR(0x04CC)
