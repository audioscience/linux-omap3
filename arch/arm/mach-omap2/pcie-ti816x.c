 ...
 */
int ti816x_pcie_setup(int nr, struct pci_sys_data *sys)
{
	 ...
	 */
	hook_fault_code(8, ti816x_pcie_fault, SIGBUS,
...
struct pci_bus *ti816x_pcie_scan(int nr, struct pci_sys_data *sys)
{
...
static struct hw_pci ti816x_pci __initdata = {
	.nr_controllers     = 1,
 ...
 */
static int __init ti816x_pcie_probe(struct platform_device *pdev)
{
